...
<div class="page-stack">
    ...
    <div class="toolbar">
        ...
        <form action="{{ route('dashboard') }}" method="GET" class="filter-form xl:w-auto">
            <select name="alert_level" class="form-control xl:w-52">
            ...
            <select name="facility_id" class="form-control xl:w-60">
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($alerts as $alert)
                        <tr class="data-row">
                            ...
                            <td data-label="Time served" class="whitespace-nowrap">
                                <div class="flex flex-col">
                            ...
                            <td data-label="Assignment" class="whitespace-nowrap">
